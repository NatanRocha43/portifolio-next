...
export const services: Service[] = [
  ...
  },
  {
    ...
    description:
      'HTML5 • CSS3 • Sass • Tailwind CSS • JavaScript • TypeScript • Node.js • React • Next.js • Stencil.js • Integração com APIs • MongoDB • MySQL • Drupal (DX8) • VTEX IO',
  ...
  },
  {
    title: 'Outras Stacks',
    description:
      'GraphQL • OracleDB • Redis • Docker • Kubernetes • OpenShift • CI/CD • Git • JUnit • DataDog • REST/GraphQL APIs • Figma',
